...
namespace Catalogo.Jogos.Repositories
{
    public class JogoRepository : IJogoRepository
    {
        ...
        {
            return Task.FromResult(jogos.Values.Where(jogo => jogo.Equals(nome) && jogo.Produtora.Equals(produtora)).ToList());
        }
